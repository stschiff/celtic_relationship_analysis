...
transformed parameters {
   real                birth_date_grandmother = burial_h - age_h - age_m_h;
   real                birth_date_sister      = burial_a - age_a - age_m_a;
   real<lower=14.3744> age_m_s                = birth_date_sister - birth_date_grandmother;
}
...
model {
  ...
  age_m_s - 14.3744 ~ gamma(2.31385, 0.262176);
}