...
parameters {
  real                              birth_date_hochdorf;
  real<lower=0>                     age_hochdorf;
  real<lower=0, upper=age_hochdorf> daughter_age_hochdorf;
  real<lower=0>                     mother_age_asperg;
  real<lower=0>                     age_asperg;
}

transformed parameters {
  real burial_date_hochdorf = birth_date_hochdorf + age_hochdorf;
  real burial_date_asperg   = birth_date_hochdorf + daughter_age_hochdorf + mother_age_asperg + age_asperg;
}
...
model {
  ...
  daughter_age_hochdorf ~ normal(father_dist_mean,          father_dist_err);
